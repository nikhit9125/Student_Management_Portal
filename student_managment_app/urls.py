...
urlpatterns = [ 
	...
	path('student_view_attendance/', StudentViews.student_view_attendence, name="student_view_attendance"), 
	path('student_view_attendance_post/', StudentViews.student_view_attendence_post, name="student_view_attendance_post"), 
